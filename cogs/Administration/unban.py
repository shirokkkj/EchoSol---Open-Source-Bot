...
class Unban(commands.Cog):
    ...
    async def ban(self, interaction: discord.Interaction, member: discord.Member, reason: str = ''):
        ...
        embed_model = EmbedsModel(title='🔨 Novo Desbanimento!',
            description=f'O usuário **{member}** acaba de ser desbanido por: **{interaction.user.mention}** com o motivo: ___{reason}___',
            color=0xff0000)
